...
Demo: <a href="https://varcel.acerohernan.com">https://varcel.acerohernan.com</a>

Github: <a href="https://github.com/acerohernan/varcel">https://github.com/acerohernan/varcel</a>

#### Overview

I admired how Google Meet allows us to communicate with people from all over the world, so I decided to make an open source project that replicates its functionality and allows to scale to the maximum number of users as possible.
